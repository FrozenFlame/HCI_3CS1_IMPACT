...
spritesheet = pygame.image.load("assets/buttons/button-tutorial.png")
...
class TutorialButton(object):
    def __init__(self, x ,y):
        ...
        character = pygame.transform.smoothscale(character, (round(203 * self.resizer), round(74 * self.resizer)))
        ...
        self.posX = x
        self.posY = y
        self.width = 200 *self.resizer
        self.height = 75 *self.resizer
    ...
    def get_evt(self, click, event, mouse):
        ...
        if event.type == pygame.MOUSEBUTTONUP:
            if click[0] == 0 and self.startPrime and (self.posX + self.width) >= mouse[0] >= self.posX and (self.posY + self.height) >= mouse[1] >= self.posY:
                ...
                print("[TutorialButton] Entering Tutorial...")
                self.message = {
                    "phase": "TO_TUTORIAL"
                }
