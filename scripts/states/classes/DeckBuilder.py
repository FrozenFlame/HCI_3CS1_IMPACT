...
class DeckCatalogue(object):
    ...
    def get_deck_king(hero_name):
        ...
        blackMarket = Card("blackmarket", "Black Market", 15, "Give 1/2 their base value to OBJECT cards on this boardfield", [Type.STRUCTURE, Type.CRIME], hero_name, "assets\\cards\\card_art\\king\\black market.png")
        ...
        slums = Card("slums", "Slums", 5, "", [Type.STRUCTURE], hero_name, "assets\\cards\\card_art\\king\\slums.png")
        ...
        slums2 = Card("slums", "Slums", 5, "", [Type.STRUCTURE], hero_name, "assets\\cards\\card_art\\king\\slums.png")
        ...
        junker2 = Card("junker", "Junker", 7, "", [Type.VEHICLE], hero_name, "assets\\cards\\card_art\\commons\\junker.png")
        ...
        scam2 = Card("scam", "Scam", 0, "Transfer to PLAYER BANK all C from one random non-CRIME PERSON card", [Type.SPELL], hero_name, "assets\\cards\\card_art\\king\\scam.png")
    ...
    def get_deck_victoria(hero_name):
        ...
        university = Card("university", "University", 15, "Double the current value of all 'STUDENT' cards on this boardfield", [Type.STRUCTURE], hero_name, "assets\\cards\\card_art\\victoria\\university.png")
        skyscraper = Card("skyscraper", "Skyscraper", 28, "", [Type.STRUCTURE], hero_name, "assets\\cards\\card_art\\victoria\\skyscraper.png")
        supplyTruck = Card("supplytruck", "Supply Truck", 8, "", [Type.VEHICLE], hero_name, "assets\\cards\\card_art\\victoria\\supply truck.png")
        riotResponseVehicle = Card("riotresponsevehicle", "Riot Response Vehicle", 10, "", [Type.VEHICLE], hero_name, "assets\\cards\\card_art\\victoria\\riotcar.png")
        innovate = Card("innovate", "Innovate", 0, "Draw 2 cards", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce = Card("solidworkforce", "Solid Workforce", 0, "+3C to all non-CRIME PERSON cards on your board", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\solid workforce.png")
        ...
        university2 = Card("university", "University", 15, "Double the current value of all 'STUDENT' cards on this boardfield", [Type.STRUCTURE], hero_name, "assets\\cards\\card_art\\victoria\\university.png")
        skyscraper2 = Card("skyscraper", "Skyscraper", 28, "", [Type.STRUCTURE], hero_name, "assets\\cards\\card_art\\victoria\\skyscraper.png")
        supplyTruck2 = Card("supplytruck", "Supply Truck", 8, "", [Type.VEHICLE], hero_name, "assets\\cards\\card_art\\victoria\\supply truck.png")
        riotResponseVehicle2 = Card("riotresponsevehicle", "Riot Response Vehicle", 10, "", [Type.VEHICLE], hero_name,"assets\\cards\\card_art\\victoria\\riotcar.png")
        innovate2 = Card("innovate", "Innovate", 0, "Draw 2 cards", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce2 = Card("solidworkforce", "Solid Workforce", 0, "+3C to all non-CRIME PERSON cards on your board", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\solid workforce.png")
    ...
    def get_deck_billy(hero_name):
        ...
        waterPurifier2 = Card("waterpurifier", "Water Purifier", 5, "+2C to all ANIMAL or PERSON cards on your board", [Type.OBJECT], hero_name, "assets\\cards\\card_art\\billy\\water purifier.png")
