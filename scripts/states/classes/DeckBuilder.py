...
class DeckCatalogue(object):
    ...
    def get_deck_king(hero_name):
        ...
        bodyDouble = Card("Body Double", 15, None, [Type.PERSON], hero_name)
        junker = Card("Junker", 7, None, [Type.VEHICLE], hero_name)
        beg = Card("Beg", 0, None, [Type.SPELL], hero_name)
        ...
        bodyDouble2 = Card("Body Double", 15, None, [Type.PERSON], hero_name)
        junker2 = Card("Junker", 7, None, [Type.VEHICLE], hero_name)
        beg2 = Card("Beg", 0, None, [Type.SPELL], hero_name)
    ...
    def get_deck_victoria(hero_name):
        insurance = Card("Insurance", 0, None, [Type.OBJECT], hero_name)
        shareHolder = Card("Share Holder", 10, None, [Type.PERSON], hero_name)
        superstar = Card("Superstar", 15, None, [Type.PERSON], hero_name)
        hacker = Card("Hacker", 15, None, [Type.PERSON, Type.BLACK], hero_name)
        ...
        innovate = Card("Innovate", 0, None, [Type.SPELL], hero_name)
        solidWorkforce = Card("Solid Workforce", 0, None, [Type.SPELL], hero_name)

        insurance2 = Card("Insurance", 0, None, [Type.OBJECT], hero_name)
        shareHolder2 = Card("Share Holder", 10, None, [Type.PERSON], hero_name)
        superstar2 = Card("Superstar", 15, None, [Type.PERSON], hero_name)
        hacker2 = Card("Hacker", 15, None, [Type.PERSON, Type.BLACK], hero_name)
        ...
        innovate2 = Card("Innovate", 0, None, [Type.SPELL], hero_name)
