...
class DeckCatalogue(object):
    ...
    def get_deck_victoria(hero_name):
        insurance = Card("insurance", "Insurance", 0, "", [Type.OBJECT], hero_name, "assets\\cards\\card_art\\victoria\\insurance.png")
        shareHolder = Card("shareholder", "Share Holder", 10, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\business people.png")
        superstar = Card("superstar", "Superstar", 15, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\superstar.png")
        hacker = Card("hacker", "Hacker", 15, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\victoria\\hacker.png")
        ...
        innovate = Card("innovate", "Innovate", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce = Card("solidworkforce", "Solid Workforce", 0, "", [Type.SPELL], hero_name)

        insurance2 = Card("insurance", "Insurance", 0, "", [Type.OBJECT], hero_name, "assets\\cards\\card_art\\victoria\\insurance.png")
        shareHolder2 = Card("shareholder", "Share Holder", 10, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\business people.png")
        superstar2 = Card("superstar", "Superstar", 15, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\superstar.png")
        hacker2 = Card("hacker", "Hacker", 15, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\victoria\\hacker.png")
        ...
        innovate2 = Card("innovate", "Innovate", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce2 = Card("solidworkforce", "Solid Workforce", 0, "", [Type.SPELL], hero_name)
