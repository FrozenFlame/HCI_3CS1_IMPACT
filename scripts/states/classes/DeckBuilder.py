...
class DeckCatalogue(object):
    ...
    def get_deck_common(hero_name):
        bagOfCash = Card("Bag of Cash", 10, "", [Type.OBJECT], hero_name)
        bigBagOfCash = Card("Big Bag of Cash", 20, "", [Type.OBJECT], hero_name)
        deed = Card("Deed", 25, "", [Type.OBJECT], hero_name)
        dollaDollaBills = Card("Dolla Dolla Bills", 7, "", [Type.OBJECT], hero_name)
        mansion = Card("Mansion", 30, "", [Type.STRUCTURE], hero_name)
        student = Card("Student", 5, "", [Type.PERSON], hero_name)
        car = Card("Car", 15, "", [Type.VEHICLE], hero_name)

        bagOfCash2 = Card("Bag of Cash", 10, "", [Type.OBJECT], hero_name)
        bigBagOfCash2 = Card("Big Bag of Cash", 20, "", [Type.OBJECT], hero_name)
        deed2 = Card("Deed", 25, "", [Type.OBJECT], hero_name)
        dollaDollaBills2 = Card("Dolla Dolla Bills", 7, "", [Type.OBJECT], hero_name)
        mansion2 = Card("Mansion", 30, "", [Type.STRUCTURE], hero_name)
        student2 = Card("Student", 5, "", [Type.PERSON], hero_name)
        car2 = Card("Car", 15, "", [Type.VEHICLE], hero_name)

        #### COMMON WITH EFFECTS ###
        butler = Card("Butler", 10, "+5C to card left of the Butler", [Type.PERSON], hero_name)
        maid = Card("Maid", 5, "+3C to your 'Mansion' cards.", [Type.PERSON], hero_name)
        policeOfficer = Card("Police Officer", 15, "Send one random enemy <PERSON> <BLACK> card to graveyard", [Type.PERSON], hero_name)
        gangsters = Card("Gangsters", 3, "", [Type.PERSON, Type.BLACK], hero_name)
        arsonist = Card("Arsonist", 0, "Destroy Opposing Column's <STRUCTURE> cards", [Type.PERSON, Type.BLACK], hero_name)
        lemonadeStand = Card("Lemonade Stand", 5, "+3C to SELF per <PERSON> card on this boardfield", [Type.STRUCTURE], hero_name)
        parkingLot = Card("Parking Lot", 5, "+2C to SELF per <VEHICLE> card on this boardfield.", [Type.STRUCTURE], hero_name)
        impoundLot = Card("Impound Lot", 5, "-2C to <VEHICLE> cards on enemy board", [Type.STRUCTURE], hero_name)
        junkyard = Card("Junkyard", 5, "+2C to SELF per <VEHICLE> card on both graveyards.", [Type.STRUCTURE], hero_name)
        loanSlip = Card("Loan Slip", 0, "-15C to Player Bank; Draw 2 cards", [Type.SPELL], hero_name)
