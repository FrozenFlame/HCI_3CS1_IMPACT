...
class DeckCatalogue(object):
    ...
    def get_deck_king(hero_name):
        ...
        slums = Card("", "Slums", 5, "", [Type.STRUCTURE], hero_name)
        ...
        slums2 = Card("", "Slums", 5, "", [Type.STRUCTURE], hero_name)
    ...
    def get_deck_billy(hero_name):
        slaughterHouse = Card("", "Slaughter House", 5, "", [Type.STRUCTURE], hero_name)
        ...
        barn = Card("", "Barn", 5, "", [Type.STRUCTURE], hero_name)
        ...
        slaughterHouse2 = Card("", "Slaughter House", 5, "", [Type.STRUCTURE], hero_name)
    ...
    def get_deck_common(hero_name):
        ...
        gangsters = Card("gangsters", "Gangsters", 5, "", [Type.PERSON, Type.BLACK], hero_name,"assets\\cards\\card_art\\commons\\gangsters.png")
        arsonist = Card("arsonist", "Arsonist", 3, "Destroy Opposing Column's STRUCTURE cards", [Type.PERSON, Type.BLACK], hero_name,"assets\\cards\\card_art\\commons\\arsonist.png")
