...
class DeckCatalogue(object):
    ...
    def get_deck_victoria(hero_name):
        ...
        skyscraper = Card("", "Skyscraper", 20, "", [Type.STRUCTURE], hero_name)
        ...
        skyscraper2 = Card("", "Skyscraper", 20, "", [Type.STRUCTURE], hero_name)
    ...
    def get_deck_common(hero_name):
        ...
        policeOfficer = Card("policeofficer", "Police Officer", 15, "Send one random enemy PERSON, BLACK card to graveyard", [Type.PERSON], hero_name)
        ...
        creditCard = Card("creditcard", "Credit Card", 0, "+2C to PERSON cards and -3C to OBJECT cards on this boardfield", [Type.SPELL], hero_name)
