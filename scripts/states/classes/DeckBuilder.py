...
class DeckCatalogue(object):
    ...
    def get_deck_common(hero_name):
        ...
        #### COMMON WITH EFFECTS ###
        butler = Card("Butler", 10, "Card left of the Butler increases in value by 5C", [Type.PERSON], hero_name)
        maid = Card("Maid", 5, "Increases your 'Mansion' cards by 3C.", [Type.PERSON], hero_name)
        policeOfficer = Card("Police Officer", 15, "Send one <PERSON> <BLACK> card on opponent's board to their graveyard", [Type.PERSON], hero_name)
        ...
        lemonadeStand = Card("Lemonade Stand", 5, "Increase C value by 3 per <PERSON> card on this boardfield", [Type.STRUCTURE], hero_name)
        parkingLot = Card("Parking Lot", 5, "Increase self value by 2 per <VEHICLE> card on this boardfield.", [Type.STRUCTURE], hero_name)
