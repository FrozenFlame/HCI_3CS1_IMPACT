...
class DeckCatalogue(object):
    ...
    def get_deck_king(hero_name):
        ...
        blackMarket = Card("", "Black Market", 15, "", [Type.STRUCTURE, Type.BLACK], hero_name)
        pickPocket = Card("", "Pick Pocket", 2, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\pickpocket.png")
        strangeGravedigger = Card("", "Gravedigger", 5, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\gravedigger.png")
        robinHood = Card("", "Robin Hood", 10, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\robin hood.png")
        slums = Card("", "Slums", 0, "", [Type.STRUCTURE], hero_name)
        kingpin = Card("", "Kingpin", 10, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\kingpin.png")
        ...
        strangeGravedigger2 = Card("", "Gravedigger", 5, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\gravedigger.png")
        robinHood2 = Card("", "Robin Hood", 10, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\robin hood.png")
        slums2 = Card("", "Slums", 0, "", [Type.STRUCTURE], hero_name)
        kingpin2 = Card("", "Kingpin", 10, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\kingpin.png")
    ...
    def get_deck_victoria(hero_name):
        insurance = Card("", "Insurance", 0, "", [Type.OBJECT], hero_name, "assets\\cards\\card_art\\victoria\\insurance.png")
        shareHolder = Card("", "Share Holder", 10, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\business people.png")
        superstar = Card("", "Superstar", 15, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\superstar.png")
        hacker = Card("", "Hacker", 15, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\victoria\\hacker.png")
        university = Card("", "University", 15, "", [Type.STRUCTURE], hero_name)
        skyscraper = Card("", "Skyscraper", 3, "", [Type.STRUCTURE], hero_name)
        supplyTruck = Card("", "Supply Truck", 8, "", [Type.VEHICLE], hero_name)
        riotResponseVehicle = Card("", "Riot Response Vehicle", 10, "", [Type.VEHICLE], hero_name)
        innovate = Card("", "Innovate", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce = Card("", "Solid Workforce", 0, "", [Type.SPELL], hero_name)

        insurance2 = Card("", "Insurance", 0, "", [Type.OBJECT], hero_name, "assets\\cards\\card_art\\victoria\\insurance.png")
        shareHolder2 = Card("", "Share Holder", 10, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\business people.png")
        superstar2 = Card("", "Superstar", 15, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\superstar.png")
        hacker2 = Card("", "Hacker", 15, "", [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\victoria\\hacker.png")
        university2 = Card("", "University", 15, "", [Type.STRUCTURE], hero_name)
        skyscraper2 = Card("", "Skyscraper", 3, "", [Type.STRUCTURE], hero_name)
        supplyTruck2 = Card("", "Supply Truck", 8, "", [Type.VEHICLE], hero_name)
        riotResponseVehicle2 = Card("", "Riot Response Vehicle", 10, "", [Type.VEHICLE], hero_name)
        innovate2 = Card("", "Innovate", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce2 = Card("", "Solid Workforce", 0, "", [Type.SPELL], hero_name)
    ...
    def get_deck_billy(hero_name):
        slaughterHouse = Card("", "Slaughter House", 0, "", [Type.STRUCTURE], hero_name)
        cropDuster = Card("", "Crop Duster", 10, "", [Type.VEHICLE], hero_name)
        farm = Card("", "Farm", 15, "", [Type.STRUCTURE], hero_name)
        farmBoy = Card("", "Farm Boy", 5, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\billy\\farmboy.png")
        barn = Card("", "Barn", 0, "", [Type.STRUCTURE], hero_name)
        cow = Card("", "Cow", 7, "", [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\cow.png")
        chicken = Card("", "Chicken", 5, "", [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\chicken.png")
        farmDog = Card("", "Farm Dog", 3, "", [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\dog.png")
        reap = Card("", "Reap", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\reap.png")
        drought = Card("", "Drought", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\drought.png")
        waterPurifier = Card("", "Water Purifier", 5, "", [Type.OBJECT], hero_name)

        slaughterHouse2 = Card("", "Slaughter House", 0, "", [Type.STRUCTURE], hero_name)
        cropDuster2 = Card("", "Crop Duster", 10, "", [Type.VEHICLE], hero_name)
        farm2 = Card("", "Farm", 15, "", [Type.STRUCTURE], hero_name)
        farmBoy2 = Card("", "Farm Boy", 5, "", [Type.PERSON], hero_name, "assets\\cards\\card_art\\billy\\farmboy.png")
        barn2 = Card("", "Barn", 0, "", [Type.STRUCTURE], hero_name)
        cow2 = Card("", "Cow", 7, "", [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\cow.png")
        chicken2 = Card("", "Chicken", 5, "", [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\chicken.png")
        farmDog2 = Card("", "Farm Dog", 3, "", [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\dog.png")
        reap2 = Card("", "Reap", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\reap.png")
        drought2 = Card("", "Drought", 0, "", [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\drought.png")
        waterPurifier2 = Card("", "Water Purifier", 5, "", [Type.OBJECT], hero_name)
    ...
    def get_deck_common(hero_name):
        bagOfCash = Card("bagofcash", "Bag of Cash", 10, "", [Type.OBJECT], hero_name)
        bigBagOfCash = Card("bigbagofcash", "Big Bag of Cash", 20, "", [Type.OBJECT], hero_name)
        deed = Card("deed", "Deed", 25, "", [Type.OBJECT], hero_name)
        dollaDollaBills = Card("dolladollabills", "Dolla Dolla Bills", 7, "", [Type.OBJECT], hero_name)
        mansion = Card("mansion", "Mansion", 30, "", [Type.STRUCTURE], hero_name)
        student = Card("student", "Student", 5, "", [Type.PERSON], hero_name)
        car = Card("car", "Car", 15, "", [Type.VEHICLE], hero_name)

        bagOfCash2 = Card("bagofcash", "Bag of Cash", 10, "", [Type.OBJECT], hero_name)
        bigBagOfCash2 = Card("bigbagofcash", "Big Bag of Cash", 20, "", [Type.OBJECT], hero_name)
        deed2 = Card("deed", "Deed", 25, "", [Type.OBJECT], hero_name)
        dollaDollaBills2 = Card("dolladollabills", "Dolla Dolla Bills", 7, "", [Type.OBJECT], hero_name)
        mansion2 = Card("mansion", "Mansion", 30, "", [Type.STRUCTURE], hero_name)
        student2 = Card("student", "Student", 5, "", [Type.PERSON], hero_name)
        car2 = Card("car", "Car", 15, "", [Type.VEHICLE], hero_name)

        #### COMMON WITH EFFECTS ###
        butler = Card("butler", "Butler", 10, "+5C to card left of the Butler", [Type.PERSON], hero_name)
        maid = Card("maid", "Maid", 5, "+3C to your 'Mansion' cards.", [Type.PERSON], hero_name)
        policeOfficer = Card("policeofficer", "PoliceOfficer", 15, "Send one random enemy PERSON, BLACK card to graveyard", [Type.PERSON], hero_name)
        ...
        lemonadeStand = Card("lemonadestand", "LemonadeStand", 5, "+3C to SELF per PERSON card on this boardfield", [Type.STRUCTURE], hero_name)
        parkingLot = Card("parkinglot", "ParkingLot", 5, "+2C to SELF per VEHICLE card on this boardfield.", [Type.STRUCTURE], hero_name)
        impoundLot = Card("impoundlot", "ImpoundLot", 5, "-2C to VEHICLE cards on enemy board", [Type.STRUCTURE], hero_name)
        junkyard = Card("junkyard", "Junkyard", 5, "+2C to SELF per VEHICLE card on both graveyards.", [Type.STRUCTURE], hero_name)
        loanSlip = Card("loanslip", "LoanSlip", 0, "-15C to Player Bank; Draw 2 cards", [Type.SPELL], hero_name)
        creditCard = Card("creditcard", "CreditCard", 0, "+2C to PERSON cards and -3C to OBJECT cards on this boardfield", [Type.SPELL], hero_name)
        resurrect = Card("resurrect", "Resurrect", 0, "Restore 1 PERSON card from your graveyard.", [Type.SPELL], hero_name)
        rebuild = Card("rebuild", "Rebuild", 0, "Restore 1 STRUCTURE or VEHICLE from your grave.", [Type.SPELL], hero_name)
        saboteur = Card("saboteur", "Saboteur", 0, "Destroy 1 random opponent card", [Type.SPELL], hero_name)
