...
class DeckBuilder(object):
    ...
    def build_deck(hero_name):
        return {
            'King': DeckCatalogue.get_deck_king(),
            'Victoria': DeckCatalogue.get_deck_victoria(),
            'Billy': DeckCatalogue.get_deck_billy()
...
class DeckCatalogue(object):
    ...
    def get_deck_billy():
        ...
        chicken = Card("Chicken", 5, None, [Type.ANIMAL], "assets\\cards\\card_art\\chicken.png")
        ...
        chicken2 = Card("Chicken", 5, None, [Type.ANIMAL], "assets\\cards\\card_art\\chicken.png")
