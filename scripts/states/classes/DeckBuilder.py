...
class DeckCatalogue(object):
    ...
    def get_deck_common(hero_name):
        ...
        policeOfficer = Card("policeofficer", "Police Officer", 15, "Send one random enemy PERSON, BLACK card to graveyard", [Type.PERSON], hero_name,"assets\\cards\\card_art\\commons\\police.png")
        gangsters = Card("gangsters", "Gangsters", 3, "", [Type.PERSON, Type.BLACK], hero_name,"assets\\cards\\card_art\\commons\\gangsters.png")
        arsonist = Card("arsonist", "Arsonist", 0, "Destroy Opposing Column's STRUCTURE cards", [Type.PERSON, Type.BLACK], hero_name,"assets\\cards\\card_art\\commons\\arsonist.png")
        ...
        creditCard = Card("creditcard", "Credit Card", 0, "+2C to PERSON cards and -3C to OBJECT cards on this boardfield", [Type.SPELL], hero_name,"assets\\cards\\card_art\\commons\\credit card.png")
