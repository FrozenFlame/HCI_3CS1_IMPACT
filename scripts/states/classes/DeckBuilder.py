...
class DeckCatalogue(object):
    ...
    def get_deck_king(hero_name):
        ...
        pickPocket = Card("Pick Pocket", 2, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\pickpocket.png")
        strangeGravedigger = Card("Gravedigger", 5, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\gravedigger.png")
        robinHood = Card("Robin Hood", 10, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\robin hood.png")
        slums = Card("Slums", 0, None, [Type.STRUCTURE], hero_name)
        kingpin = Card("Kingpin", 10, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\kingpin.png")
        bodyDouble = Card("Body Double", 15, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\king\\double.png")
        junker = Card("Junker", 7, None, [Type.VEHICLE], hero_name)
        beg = Card("Beg", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\king\\beg.png")
        scam = Card("Scam", 0, None, [Type.SPELL, Type.BLACK], hero_name)

        blackMarket2 = Card("Black Market", 15, None, [Type.STRUCTURE, Type.BLACK], hero_name)
        pickPocket2 = Card("Pick Pocket", 2, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\pickpocket.png")
        strangeGravedigger2 = Card("Gravedigger", 5, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\gravedigger.png")
        robinHood2 = Card("Robin Hood", 10, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\robin hood.png")
        slums2 = Card("Slums", 0, None, [Type.STRUCTURE], hero_name)
        kingpin2 = Card("Kingpin", 10, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\king\\kingpin.png")
        bodyDouble2 = Card("Body Double", 15, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\king\\double.png")
        junker2 = Card("Junker", 7, None, [Type.VEHICLE], hero_name)
        beg2 = Card("Beg", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\king\\beg.png")
        scam2 = Card("Scam", 0, None, [Type.SPELL, Type.BLACK], hero_name)
    ...
    def get_deck_victoria(hero_name):
        insurance = Card("Insurance", 0, None, [Type.OBJECT], hero_name, "assets\\cards\\card_art\\victoria\\insurance.png")
        shareHolder = Card("Share Holder", 10, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\business people.png")
        superstar = Card("Superstar", 15, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\superstar.png")
        hacker = Card("Hacker", 15, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\victoria\\hacker.png")
        university = Card("University", 15, None, [Type.STRUCTURE], hero_name)
        skyscraper = Card("Skyscraper", 3, None, [Type.STRUCTURE], hero_name)
        supplyTruck = Card("Supply Truck", 8, None, [Type.VEHICLE], hero_name)
        riotResponseVehicle = Card("Riot Response Vehicle", 10, None, [Type.VEHICLE], hero_name)
        innovate = Card("Innovate", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce = Card("Solid Workforce", 0, None, [Type.SPELL], hero_name)

        insurance2 = Card("Insurance", 0, None, [Type.OBJECT], hero_name, "assets\\cards\\card_art\\victoria\\insurance.png")
        shareHolder2 = Card("Share Holder", 10, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\business people.png")
        superstar2 = Card("Superstar", 15, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\victoria\\superstar.png")
        hacker2 = Card("Hacker", 15, None, [Type.PERSON, Type.BLACK], hero_name, "assets\\cards\\card_art\\victoria\\hacker.png")
        university2 = Card("University", 15, None, [Type.STRUCTURE], hero_name)
        skyscraper2 = Card("Skyscraper", 3, None, [Type.STRUCTURE], hero_name)
        supplyTruck2 = Card("Supply Truck", 8, None, [Type.VEHICLE], hero_name)
        riotResponseVehicle2 = Card("Riot Response Vehicle", 10, None, [Type.VEHICLE], hero_name)
        innovate2 = Card("Innovate", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\victoria\\innovation.png")
        solidWorkforce2 = Card("Solid Workforce", 0, None, [Type.SPELL], hero_name)
    ...
    def get_deck_billy(hero_name):
        ...
        farm = Card("Farm", 15, None, [Type.STRUCTURE], hero_name)
        farmBoy = Card("Farm Boy", 5, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\billy\\farmboy.png")
        barn = Card("Barn", 0, None, [Type.STRUCTURE], hero_name)
        cow = Card("Cow", 7, None, [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\cow.png")
        chicken = Card("Chicken", 5, None, [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\chicken.png")
        farmDog = Card("Farm Dog", 3, None, [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\dog.png")
        reap = Card("Reap", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\reap.png")
        drought = Card("Drought", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\drought.png")
        waterPurifier = Card("Water Purifier", 5, None, [Type.OBJECT], hero_name)

        slaughterHouse2 = Card("Slaughter House", 0, None, [Type.STRUCTURE], hero_name)
        cropDuster2 = Card("Crop Duster", 10, None, [Type.VEHICLE], hero_name)
        farm2 = Card("Farm", 15, None, [Type.STRUCTURE], hero_name)
        farmBoy2 = Card("Farm Boy", 5, None, [Type.PERSON], hero_name, "assets\\cards\\card_art\\billy\\farmboy.png")
        barn2 = Card("Barn", 0, None, [Type.STRUCTURE], hero_name)
        cow2 = Card("Cow", 7, None, [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\cow.png")
        chicken2 = Card("Chicken", 5, None, [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\chicken.png")
        farmDog2 = Card("Farm Dog", 3, None, [Type.ANIMAL], hero_name, "assets\\cards\\card_art\\billy\\dog.png")
        reap2 = Card("Reap", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\reap.png")
        drought2 = Card("Drought", 0, None, [Type.SPELL], hero_name, "assets\\cards\\card_art\\billy\\drought.png")
    ...
    def get_deck_common(hero_name):
        bagOfCash = Card("Bag of Cash", 10, None, [Type.OBJECT], hero_name)
        bigBagOfCash = Card("Big Bag of Cash", 20, None, [Type.OBJECT], hero_name)
        deed = Card("Deed", 25, None, [Type.OBJECT], hero_name)
        dollaDollaBills = Card("Dolla Dolla Bills", 7, None, [Type.OBJECT], hero_name)
        mansion = Card("Mansion", 30, None, [Type.STRUCTURE], hero_name)
        student = Card("Student", 5, None, [Type.PERSON], hero_name)
        car = Card("Car", 15, None, [Type.VEHICLE], hero_name)

        bagOfCash2 = Card("Bag of Cash", 10, None, [Type.OBJECT], hero_name)
        bigBagOfCash2 = Card("Big Bag of Cash", 20, None, [Type.OBJECT], hero_name)
        deed2 = Card("Deed", 25, None, [Type.OBJECT], hero_name)
        dollaDollaBills2 = Card("Dolla Dolla Bills", 7, None, [Type.OBJECT], hero_name)
        mansion2 = Card("Mansion", 30, None, [Type.STRUCTURE], hero_name)
        student2 = Card("Student", 5, None, [Type.PERSON], hero_name)
        car2 = Card("Car", 15, None, [Type.VEHICLE], hero_name)

        #### COMMON WITH EFFECTS ###
        butler = Card("Butler", 10, None, [Type.PERSON], hero_name)
        maid = Card("Maid", 5, None, [Type.PERSON], hero_name)
        policeOfficer = Card("Police Officer", 15, None, [Type.PERSON], hero_name)
        gangsters = Card("Gangsters", 3, None, [Type.PERSON, Type.BLACK], hero_name)
        arsonist = Card("Arsonist", 0, None, [Type.PERSON, Type.BLACK], hero_name)
        lemonadeStand = Card("Lemonade Stand", 5, None, [Type.STRUCTURE], hero_name)
        parkingLot = Card("Parking Lot", 5, None, [Type.STRUCTURE], hero_name)
        impoundLot = Card("Impound Lot", 5, None, [Type.STRUCTURE], hero_name)
        junkyard = Card("Junkyard", 5, None, [Type.STRUCTURE], hero_name)
        loanSlip = Card("Loan Slip", 0, None, [Type.SPELL], hero_name)
        creditCard = Card("Credit Card", 0, None, [Type.SPELL], hero_name)
        resurrect = Card("Resurrect", 0, None, [Type.SPELL], hero_name)
        rebuild = Card("Rebuild", 0, None, [Type.SPELL], hero_name)
        saboteur = Card("Saboteur", 0, None, [Type.SPELL], hero_name)
